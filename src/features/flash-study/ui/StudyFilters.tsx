...
import { difficultyOptions } from '@/features/flash-card/model/options';
import { SelectOptions } from '@/shared/types/select.types';
import Select from 'react-select';
import { filterOptions, limitOptions, sortOptions } from '../model/constants';
import { Difficulty, Filter, FilterTypeProps, Limit, Sort } from '../model/types/flash.study.types';

import styles from '@/styles/flashcard-block/flashcard.module.scss';


export const StudyFilters = ({ setFilters, filters }: FilterTypeProps) => {
